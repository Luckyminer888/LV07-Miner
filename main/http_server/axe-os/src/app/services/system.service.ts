...
export class SystemService {
      ...
      return of(
        {
          ...
          fallbackStratumUser: "bc1q99n3pu025yyu0jlywpmwzalyhm36tg5u37w20d.Lucky-U1",
  ...
  public getUptime(search: string){
    return this.httpClient.get(`/api/system/up?` + search);
  }
