...
#define TPS546_INIT_VOUT_COMMAND 1.25  /* V absolute value */
...
#define TPS546_INIT_VOUT_MIN 1 /* v */
  ...
  /* iout current */
#define TPS546_INIT_IOUT_OC_WARN_LIMIT  35.00 /* A */
#define TPS546_INIT_IOUT_OC_FAULT_LIMIT 40.00 /* A */
